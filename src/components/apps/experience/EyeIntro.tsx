// A purely decorative "eye" loading animation, played once before the
// Experience timeline reveals itself — the same "intro plays, then content
// fades in" pattern BentoProfile already uses (see its own `INTRO_MS`
// comment). Adapted from a plain CSS/HTML snippet the user supplied, which
// was originally written to own the whole page (`body`/`body *` selectors,
// viewport units) — here it's scoped under `.eye-intro-root` so it can live
// inside a single AppWindow instead, and every class/keyframe/clip-path name
// is prefixed (`exp*`) so it can't collide with anything else in the app's
// global stylesheet.
export default function EyeIntro() {
  return (
    <div className="eye-intro-root">
      <style>{EYE_INTRO_CSS}</style>
...
.eye-intro-root *, .eye-intro-root *:before, .eye-intro-root *:after {
  content: '';
  position: absolute;
  top: 50%; left: 50%;
}
...
.eye-intro-root .eye {
  ...
  background: #EBEDF3;
  filter: blur(5px);
  animation: expEyeAnimation 4s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expEyeAnimation {
  0%, 33%, 100% {
...
.eye-intro-root .circle-1 {
  width: 475px; height: 475px;
  border-radius: 50%;
  border: 1px solid transparent;
  border-right-color: rgba(223, 228, 255, 0.6);
  animation: expCircle1AnimationOpacity 4s ease infinite,
             expCircle1AnimationMove 4s ease infinite;
}
@keyframes expCircle1AnimationMove {
...
@keyframes expCircle1AnimationOpacity {
  00%, 27%, 73%, 100% { opacity: 1; }
  30%, 70%            { opacity: 0; }
}

.eye-intro-root .circle-2 {
  width: 475px; height: 475px;
  border-radius: 50%;
  border: 1px solid transparent;
  border-right-color: rgba(223, 228, 255, 0.6);
  animation: expCircle2AnimationOpacity 4s ease infinite,
             expCircle2AnimationMove 4s ease infinite;
}
@keyframes expCircle2AnimationMove {
...
@keyframes expCircle2AnimationOpacity {
  0%, 27%, 79%, 100% { opacity: 1; }
  30%, 76%           { opacity: 0; }
}

.eye-intro-root .circle-3 {
  left: calc(50% + 93px);
  top: calc(50% - 189px);
  width: 106px; height: 280px;
  overflow: hidden;
}
.eye-intro-root .circle-3::before {
  left: -275%;
  top: -4%;
  width: 393px;
  height: 393px;
  ...
  border: 1px solid transparent;
  border-right-color: rgba(223, 228, 255, 0.6);
  animation: expCircle3Animation 4s ease infinite;
}
@keyframes expCircle3Animation {
...
.eye-intro-root .circle-4 {
  width: 295px; height: 295px;
  border-radius: 50%;
  border: 1px solid transparent;
  border-right-color: rgb(251, 251, 251);
  border-left-color: rgba(251, 251, 251, 0.2);
  animation: expCircle4AnimationMove 4s cubic-bezier(1, 0, 1, 1) infinite,
             expCircle4AnimationOpacity 4s ease infinite;
}
@keyframes expCircle4AnimationMove {
...
@keyframes expCircle4AnimationOpacity {
  00%, 33%, 50%, 100% { opacity: 1; }
  36%, 39%            { opacity: 0; }
}

.eye-intro-root .circle-5 {
  width: 100px; height: 100px;
  transform: translate(-50%, -50%);
  animation: expCircle5AnimationSize 4s cubic-bezier(1, 0, 1, 1) infinite,
             expCircle5AnimationView 4s ease infinite;
}
.eye-intro-root .circle-5::before {
  width: 173px; height: 173px;
  border-radius: 50%;
  border: 1px solid rgb(251, 251, 251);
  transform: translate(-50%, -50%);
}
.eye-intro-root .circle-5::after {
  width: 177px; height: 177px;
  border-radius: 50%;
  border: 1px solid rgb(251, 251, 251);
  transform: translate(-50%, -50%);
}
@keyframes expCircle5AnimationSize {
  0%, 38%, 82.82%, 100% { transform: translate(-50%, -50%) scale(1); }
  45%, 75.44%           { transform: translate(-50%, -50%) scale(0.7); }
}
@keyframes expCircle5AnimationView {
...
.eye-intro-root .circle-6 {
  top: 50%; left: 50%;
  width: 190px; height: 190px;
  background: repeating-conic-gradient(from 0deg, rgba(179, 221, 255, 0.4) 0deg 1deg, transparent 1deg 2deg);
  clip-path: url(#expBagel1);
  border-radius: 50%;
  animation: expCircle6Animation 4s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expCircle6Animation {
...
.eye-intro-root .circle-7 {
  top: 50%; left: 50%;
  width: 142px; height: 142px;
  filter: blur(1px);
  animation: expCircle6Animation 4s -0.1s cubic-bezier(1, 0, 1, 1) infinite;
}
.eye-intro-root .circle-7::before {
  top: 0; left: 0;
  width: 100%; height: 100%;
  background: repeating-conic-gradient(from 0deg, rgba(114, 87, 187, 0.6) 0deg 2deg, transparent 2deg 8deg);
  clip-path: url(#expBagel2);
  border-radius: 50%;
}

.eye-intro-root .circle-8 {
  top: 50%; left: 50%;
  width: 120px; height: 120px;
  background: repeating-conic-gradient(from 0deg, rgba(236, 247, 255, 0.68) 0deg 1deg, transparent 1deg 2deg);
  clip-path: url(#expBagel3);
  border-radius: 50%;
  animation: expCircle6Animation 4s -0.13s cubic-bezier(1, 0, 1, 1) infinite;
}

.eye-intro-root .circle-9 {
  top: 50%; left: 50%;
  width: 76px; height: 76px;
  background: repeating-conic-gradient(from 0deg, rgba(236, 247, 255, 0.68) 0deg 1deg, transparent 1deg 2deg);
  clip-path: url(#expBagel4);
  border-radius: 50%;
  animation: expCircle6Animation 4s -0.16s cubic-bezier(1, 0, 1, 1) infinite;
}

.eye-intro-root .circle-10 {
  top: 50%; left: 50%;
  width: 190px; height: 190px;
  background: radial-gradient(rgba(230, 245, 255, 0.6), rgba(201, 243, 255, 0.5), rgba(74, 105, 160, 0.3), transparent 70%);
  clip-path: url(#expBagel1);
  border-radius: 50%;
  animation: expCircle10Animation 4s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expCircle10Animation {
  0% { transform: translate(-50%, -50%) scale(1); }
...
.eye-intro-root .circle-11 {
  ...
  clip-path: url(#expBagel1);
  border-radius: 50%;
  animation: expCircle11Animation 4s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expCircle11Animation {
...
.eye-intro-root .circle-12 {
  ...
  clip-path: url(#expBagel1);
  border-radius: 50%;
  animation: expCircle12Animation 4s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expCircle12Animation {
...
.eye-intro-root .circle-13 {
  width: 100px; height: 100px;
  transform: translate(-50%, -50%);
  animation: expCircle13AnimationSize 4s cubic-bezier(1, 0, 1, 1) infinite,
             expCircle13AnimationView 4s ease infinite;
}
.eye-intro-root .circle-13::before {
  width: 110px; height: 110px;
  border-radius: 50%;
  border: 1px solid rgb(251, 251, 251);
  transform: translate(-50%, -50%);
}
.eye-intro-root .circle-13::after {
  width: 120px; height: 120px;
  border-radius: 50%;
  border: 1px solid rgba(251, 251, 251, 0.5);
  transform: translate(-50%, -50%);
}
@keyframes expCircle13AnimationSize {
  0%, 32%, 86%, 100% { transform: translate(-50%, -50%) scale(1); }
  38%, 82% { transform: translate(-50%, -50%) scale(0.2); }
}
@keyframes expCircle13AnimationView {
  0% { opacity: 1; }
  2.5% { opacity: 0.5; }
  5.7% { opacity: 1; }
  6.6% { opacity: 0.5; }
...
.eye-intro-root .circle-14 {
  width: 100px; height: 100px;
  transform: translate(-50%, -50%);
  animation: expCircle13AnimationSize 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite,
             expCircle14AnimationView 4s ease infinite;
}
.eye-intro-root .circle-14::before {
  width: 70px; height: 70px;
  border-radius: 50%;
  border: 1px solid rgba(251, 251, 251, 0.5);
  transform: translate(-50%, -50%);
}
.eye-intro-root .circle-14::after {
  width: 95px; height: 95px;
  border-radius: 50%;
  border: 1px solid rgba(251, 251, 251, 0.3);
  transform: translate(-50%, -50%);
}
@keyframes expCircle14AnimationView {
  0% { opacity: 1; }
  2.5% { opacity: 0.5; }
  5.7% { opacity: 1; }
  6.6% { opacity: 0.5; }
...
.eye-intro-root .glitch {
  ...
  filter: blur(1px);
  animation: expGlitchAnimationOpacity 4s cubic-bezier(1, 0, 1, 1) infinite,
             expGlitchAnimationMove 4s cubic-bezier(1, 0, 1, 1) infinite,
             expGlitchAnimationBright 4s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expGlitchAnimationOpacity {
  0%, 30%, 96%, 100% { opacity: 1; }
  35%, 93%           { opacity: 0; }
}
@keyframes expGlitchAnimationMove {
  0%, 100% { transform: translate(-50%, -50%) rotate(0deg); }
  35%, 65% { transform: translate(-50%, -50%) rotate(4320deg); }
}
@keyframes expGlitchAnimationBright {
  0%, 100% { filter: blur(1px); }
  35%, 65% { filter: blur(1px) brightness(1.8); }
}

.eye-intro-root .fragment-1::before {
  width: 6px; height: 6px;
  border: 2px solid rgba(255, 255, 255, 0.3);
  border-radius: 2px;
  animation: expFragment1BeforeAnimationMove 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expFragment1BeforeAnimationMove {
...
.eye-intro-root .fragment-1::after {
  width: 6px; height: 6px;
  border: 2px solid rgba(255, 255, 255, 0.3);
  border-radius: 2px;
  animation: expFragment1AfterAnimationMove 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expFragment1AfterAnimationMove {
...
.eye-intro-root .fragment-2::after {
  width: 6px; height: 6px;
  border: 2px solid rgba(255, 255, 255, 0.3);
  border-radius: 2px;
  animation: expFragment2AfterAnimationMove 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expFragment2AfterAnimationMove {
...
.eye-intro-root .fragment-2::before {
  width: 6px; height: 6px;
  border: 2px solid rgba(255, 255, 255, 0.3);
  border-radius: 2px;
  animation: expFragment2BeforeAnimationMove 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expFragment2BeforeAnimationMove {
...
.eye-intro-root .fragment-3::after {
  width: 6px; height: 6px;
  background: rgba(255, 255, 255, 0.3);
  border-radius: 2px;
  animation: expFragment3AfterAnimationMove 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expFragment3AfterAnimationMove {
...
.eye-intro-root .fragment-3::before {
  width: 6px; height: 6px;
  background: rgba(255, 255, 255, 0.3);
  border-radius: 2px;
  animation: expFragment3BeforeAnimationMove 4s -0.15s cubic-bezier(1, 0, 1, 1) infinite;
}
@keyframes expFragment3BeforeAnimationMove {
