// From Magic UI (https://magicui.design/docs/components/animated-circular-progress-bar),
// adapted only to use this project's relative-import convention for `cn`
// instead of the `@/` alias (which maps to the repo root here, not `src/`).
